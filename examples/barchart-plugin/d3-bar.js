(function (global, factory) {
  ...
  (factory((global.d3_bar = global.d3_bar || {}),global.d3_array,global.d3_collection,global.d3_interpolate,global.d3_format,global.d3_time,global.d3_time_format,global.d3_color));
  ...
  var getXRange = getRangeCurried('x');
  var getYRange = getRangeCurried('y');
  ...
  function bar (_config) {
    ...
    function exports(selection) {
      ...
      // check for data.
      var xScale = config.xScale || band()
          .rangeRound(getXRange(config), 0.1)
          .padding(0.1);
      var yScale = config.yScale || linear()
      ...
      var bars = barG
        .selectAll('.bar')
        .data(data, invertOrientation ? config.yAccessor : config.xAccessor);
      bars.exit()
        .remove();
      bars.enter()
        .append('rect')
          .attr('class', 'bar')
          .attr('x', invertOrientation ? config.leftPadding : config.bottomPaddign)
        .merge(bars).transition(config.transition)
          .attr('y', function(d) {yScale(config.yAccessor(d))})
          .attr('width', function(d) {xScale(config.xAccessor(d))})
