...
var variance$1 = function(array, f) {
  var n = array.length,
      m = 0,
      a,
      d,
  ...
  if (f == null) {
    ...
    while (++i < n) {
      if (!isNaN(a = number$3(f(array[i], i, array)))) {
        d = a - m;
        m += d / ++j;
        s += d * (a - m);
      }
...
var quantile$1 = function(array, p, f) {
...
exports.timer = timer;
exports.interpolateArray = array$4;
exports.interpolateNumber = number$4;
